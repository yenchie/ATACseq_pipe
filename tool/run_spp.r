...
if (!require("spp", quietly = TRUE)) {
  install.packages("/bcst/JYL/JYL_qnap_2/YCWang/0_Script/Project/Gm/ChIPseq/Peakcalling/spp_1.16.0.tar", repos = NULL, dependencies=TRUE)
}
library(caTools)
library(snow)
library(spp)
